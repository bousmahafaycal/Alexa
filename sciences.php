...
<html lang="fr">
    ...
    <body>
        ...
        <section id="part_index"> <!-- peut etre à enlever si je laisse une seule section -->
          <div class="left">
            <div class="last_article">
              ...
              <?php
                $req = $bdd->query('SELECT id, idAuteur, titre, idCategorie, corps, DATE_FORMAT(date_creation, \'%d/%m/%Y à %Hh%i\') AS date_creation_fr FROM Article WHERE idCategorie=4 AND affiche=1 AND invisibleAuteur=0 ORDER BY date_creation DESC LIMIT 0, 1');
            ...
            <div class="articles">
              ...
              <?php 
                $req = $bdd->query('SELECT id, idAuteur, titre, idCategorie, corps, DATE_FORMAT(date_creation, \'%d/%m/%Y\') AS date_creation_fr FROM Article WHERE idCategorie=4 AND affiche=1 AND invisibleAuteur=0 ORDER BY date_creation DESC LIMIT 1, 4');
      ...
      <div class="container accesListe">
        <a class="sinslink_bis linkListe" href="sciencesListe.php">Acceder à la liste de tous les articles de cette catégorie</a>
      </div>
